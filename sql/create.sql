...
CREATE TABLE IF NOT EXISTS `wetr`.`province` (
  ...
  INDEX `fk_province_country1_idx` (`countryId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wetr`.`district` (
  ...
  INDEX `fk_district_province1_idx` (`provinceId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wetr`.`community` (
  ...
  INDEX `fk_community_district1_idx` (`districtId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wetr`.`address` (
  ...
  INDEX `fk_address_community1_idx` (`communityId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wetr`.`station` (
  ...
  INDEX `fk_station_stationType1_idx` (`stationTypeId` ASC) VISIBLE,
  INDEX `fk_station_address1_idx` (`addressId` ASC) VISIBLE,
  INDEX `fk_station_user1_idx` (`userId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wetr`.`measurement` (
  ...
  INDEX `fk_measurement_station1_idx` (`stationId` ASC) VISIBLE,
  INDEX `fk_measurement_unit1_idx` (`unitId` ASC) VISIBLE,
  INDEX `fk_measurement_measurementType1_idx` (`measurementTypeId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wetr`.`hasPermission` (
  ...
  INDEX `fk_permission_has_user_permission1_idx` (`permissionId` ASC) VISIBLE,
